                            ...
                            new AsyncTask<Void, Void, Void>() {
                                ...
                                protected Void doInBackground(Void... params) {
                                    ...
                                    try {
                                        ...
                                        JsonObject jsonObject = HttpUtil.getResposeJsonObject("合并搜索3:",BMA.Search.searchMerge(adapterMusicInfo.artist, 1, 50)).get("result").getAsJsonObject();
                            ...
                            new AsyncTask<Void, Void, Void>() {
                                ...
                                protected Void doInBackground(Void... params) {
                                    ...
                                    try {
                                        ...
                                        JsonObject jsonObject = HttpUtil.getResposeJsonObject("合并搜索4:",BMA.Search.searchMerge(adapterMusicInfo.albumName, 1, 10)).get("result").getAsJsonObject();
//                                        JsonObject artistObject =  jsonObject.get("artist_info").getAsJsonObject();
//                                        JsonArray artistArray = artistObject.get("artist_list").getAsJsonArray();
//                                        for (JsonElement o : artistArray) {
//                                            SearchArtistInfo artistInfo =  MainApplication.gsonInstance().fromJson(o, SearchArtistInfo.class);
